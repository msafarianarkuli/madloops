                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 px-5 sm:gap-5 md:gap-8 lg:gap-8 xl:mx-28">
                        ...
                        <div>
                          <Textarea
                            ...
                            className="rounded-lg py-2 bg-[#F1F2F7] outline-none w-full min-h-full max-h-64 px-4 border-2 border-[#F1F2F7] focus:border-lite-purple focus:bg-white"
                          />
                        </div>
                      </div>
                      <Button
                        ButtonType="submit"
                        classButton="sm:relative left-0 top-0 absolute border-2 sm:rounded-xl rounded-br-xl text-base pt-2 pb-2 mb-3 px-10 ease-in-out duration-300 border-[#8055D9] bg-[#8055D9] text-white
                        hover:bg-[#673CC0] hover:border-[#673CC0] hover:button-shadow duration-300 ease-in-out mx-auto block"
                      >
                        ارسال پیام
                      </Button>
                    </Form>
