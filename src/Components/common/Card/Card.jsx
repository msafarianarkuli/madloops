...
const CardAI = ({ item }) => {
  ...
  return (
    <div className="bg-white text-gray-500 hover:-translate-y-2 hover:z-50 transition ease-in-out duration-300 custom-shadow rounded-lg p-3 my-4 flex flex-col group">
      ...
      <div className="">
        ...
        <Button
          ...
          ButtonType="button"
          classButton="btn btn-base w-full group-hover:border-lite-purple lg:group-hover:block lg:hidden transition ease-in-out duration-300"
        >
          جزئیات دوره
        </Button>
      </div>
