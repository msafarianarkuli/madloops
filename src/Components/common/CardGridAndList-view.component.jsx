      ...
      {item ? (
        <>
          {view ? (
            <div
              role="status"
              className="space-y-8 sm:mt-4 mt-8 animate-pulse sm:space-y-0 sm:space-x-8 sm:flex items-center"
            >
        ...
        >
          ...
          >
            ...
            >
              <Button className="hover:btn-base md:w-[20%] sm:w-fit w-fit h-full md:p-4 sm:p-2 p-[11px] rounded-r-md self-end">
                <BsFillShareFill className="mx-auto dark:text-[#E5E7EB]" />
              </Button>
              <Button className="hover:btn-base md:w-[20%] sm:w-fit w-fit h-fit md:p-4 sm:p-2 p-[11px] self-end">
