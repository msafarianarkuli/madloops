                ...
                <>
                  {!showCard && isActive ? (
                    ...
                    <div
                      className={
                        isActive
                          ? "hidden m-auto rounded-full p-5 bg-gray-200 cursor-pointer hover:bg-slate-400 transition  ease-in delay-200 hover:transition hover:ease-out hover:delay-200"
                          : isPrev || isNext
                          ? "m-auto inline-block rounded-full p-5 opacity-75 bg-gray-200"
                          : "m-auto inline-block rounded-full p-5 opacity-50 bg-gray-200"
                      }
                  ...
                  {showCard && isActive ? (
                    <div
                      className={
                        showCard &&
                        "grid lg:grid-cols-2 w-full animate-card rounded-3xl bg-[#F4F5F9]"
                      }
                    >
                      <div className="sm:mr-8 p-3 sm:ml-8 lg:ml-0">
                        <div className="flex md:justify-between justify-center">
                          ...
                          <div
                            className="md:mr-14 lg:hidden sm:block cursor-pointer"
                            onClick={() => setShowCard(!showCard)}
                          >
                            <img
                              src={require("../../../Assets/mohsen.jpg")}
