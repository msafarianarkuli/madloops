...
const Dashboard = () => {
  return (
    <>
      ...
      px-3 lg:px-10 mx-2 md:mx-10 py-5 my-5 text-lg lg:text-2xl "
      >
        <p>
          نام:{' '}
          <span className="text-lite-purple font-bold">میکائیل</span>
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mx-2 lg:mx-10 mt-6">
        <div>
          ...
          <div className="border-4 rounded-3xl py-4 px-6 flex bg-gradient-to-l from-light-gray to-white">
        ...
        <div>
          ...
          <div className="border-4 rounded-3xl py-4 px-6 flex bg-gradient-to-l from-light-gray to-white mb-6">
            <img src={reactIcon} className="w-20" />
