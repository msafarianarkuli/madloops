            ...
            <Form>
              <div className="flex flex-col items-center mt-10 animate-[onLoadPanel_.5s_ease-in]">
                <InputFeild
                  ...
                  type="password"
                  id="password"
                  classInput="dark:bg-transparent focus:border-lite-purple dark:focus:border-lite-purple dark:text-white dark:border-gray-500 sm:w-96 w-80 p-2 mb-1 border border-[#B7B7B7] focus:border-transparent bg-white rounded-md outline-none duration-300"
