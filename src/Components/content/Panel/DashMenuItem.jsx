    ...
    <NavLink
      ...
      className={`${
        pathname.slice(12) === path || pathname.slice(12) === null
          ? 'bg-white rounded-md lg:rounded-xl mt-4 p-2 flex shadow-purple text-lite-purple transition ease-in duration-200'
          : 'bg-white rounded-md lg:rounded-xl mt-4 hover:shadow-purple text-gray-500 p-2 flex transition ease-in duration-200'
      } ${
        title === 'خروج'
