...
const TableRow = ({ course, onDelete, onAdd }) => {
  ...
  return (
    <tr className="group border-b text-lite-purple group hover:bg-zinc-50 hover:shadow-sm hover:border-b-0 hover:-translate-y-1 transition ease-in-out duration-200">
      <td className="px-xl py-4 font-medium text-center hidden sm:table-cell">
        <img src={courseIcon} className="w-12 mx-auto group-hover:rotate-[360deg] duration-700" />
      </td>
