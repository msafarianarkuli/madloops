...
const Call = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-12 text-lg">
      <div className="flex justify-evenly border-2 border-lite-purple rounded-lg py-14 lg:mx-10 dark:bg-dark-secondary">
      ...
      <div className="flex justify-evenly items-center border-2 border-lite-purple rounded-lg py-14 lg:mx-10 sm:px-5 xl:px-0 dark:bg-dark-secondary ">
        <div className="flex items-center text-lite-purple dark:text-dark-text">
